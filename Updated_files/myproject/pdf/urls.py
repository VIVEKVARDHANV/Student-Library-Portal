...
urlpatterns = [
    ...
    path('pdf/display_be/<str:success_message>/', views.display_be, name='display_pdf_with_message_be'),
    path('pdf/display_bme/<str:success_message>/', views.display_bme, name='display_pdf_with_message_bme'),
    path('pdf/display_mos/<str:success_message>/', views.display_mos, name='display_pdf_with_message_mos'),
    path('pdf/display_chem/<str:success_message>/', views.display_chem, name='display_pdf_with_message_chem'),
    path('pdf/display_maths/<str:success_message>/', views.display_maths, name='display_pdf_with_message_maths'),
    ...
    path('first/', views.first_year, name='first_year'),

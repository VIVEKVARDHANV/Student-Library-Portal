    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                user_points.save()
                # Redirect to display_pdf page with success message
                return redirect('display_pdf_with_message_bme', success_message="File uploaded successfully")
        else:
            form = PDFFileFormbme()
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                user_points.save()
                # Redirect to display_pdf page with success message
                return redirect('display_pdf_with_message_chem', success_message="File uploaded successfully")
        else:
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                user_points.save()
                # Redirect to display_pdf page with success message
                return redirect('display_pdf_with_message_maths', success_message="File uploaded successfully")
        else:
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                user_points.save()
                # Redirect to display_pdf page with success message
                return redirect('display_pdf_with_message_mos', success_message="File uploaded successfully")
        else:
            form = PDFFileFormmos()
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                user_points.save()
                # Redirect to display_pdf page with success message
                return redirect('display_pdf_with_message_be', success_message="File uploaded successfully")
        else:
            form = PDFFileFormbe()
